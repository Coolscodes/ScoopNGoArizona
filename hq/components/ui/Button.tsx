...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  return (
    <button
      ref={ref}
      className={cn(
        'inline-flex items-center justify-center gap-1.5 rounded-[7px] font-heading font-bold cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-dark',
        variants[variant],
        sizes[size],
        className
      )}
